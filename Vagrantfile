...
Vagrant.configure(2) do |config|
  config.vm.define "samba_storage" do |samba_storage_config|
    ...
    samba_storage_config.vm.network "private_network", ip: "10.1.4.10", :netmask => "255.255.255.0", virtualbox__intnet: "intnet2"
  ...
  config.vm.define "samba_client" do |samba_client_config|
    ...
    samba_client_config.vm.network "private_network", ip: "10.1.4.11", :netmask => "255.255.255.0", virtualbox__intnet: "intnet2"
  ...
  config.vm.provision :hosts do |provisioner|
    provisioner.add_host '10.1.4.10', ['samba-storage.local']
    provisioner.add_host '10.1.4.11', ['samba-client.local']
  end
